...
if (isset($_GET['remove_id'])) {
  ...
  if(!$admin->removeUser($id)){
    echo '<script>';
    echo 'alert("Seller Removed Successfully")';
    echo 'window.location.href = "view_sellers.php"';
    echo '</script>';
  }else{
    echo '<script>';
...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">View Sellers</a>
              </li>
              <li class="nav-item">
    ...
    <h2 style="color:DarkSlateGrey;">Sellers @ OPRE</h2>
    <p>Below are the sellers who registered to OPRE</p>
    <?php $admin->viewSellers(); ?>
