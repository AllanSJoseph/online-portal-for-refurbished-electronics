...
if ( isset($_GET['category']) && isset($_GET['query'])){
    ...
    $query = $_GET['query'];
    $products = $buyer->searchProduct($query,$category);
}
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <form class="d-xl-flex navform" role="search"  method="GET" action="search.php">
                <div class="input-group">
                    ...
                    <input class="form-control search" name="query" id="query" style="width: 10rem;" type="search" placeholder="Enter item for search" aria-label="Search">
...
<h1 style="color:DarkSlateGrey;">Showing Results for: <?php echo $query; ?></h1>
