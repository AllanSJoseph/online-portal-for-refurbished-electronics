...
<html lang="en">
    <head>
        ...
        <style>
            ...
            align-items: center;
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url('./res/background/background_seller.jpg') no-repeat center center fixed; 
     ...
     if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(isset($_POST["name"]) && isset($_POST["email"]) && isset($_POST["mob"]) && isset($_POST["address"]) && isset($_POST["password"])){
            ...
            if (mysqli_num_rows($checkDuplicate) === 0){
                $query = "INSERT INTO users VALUES(NULL,\"$email\",\"$name\",\"$mob\",\"$address\",\"$password\",\"Seller\")";
   ...
   <div class="container-form-suggestion">
        ...
        <h1 style="text-align: center;"><b>Register as Seller</b></h1>
        <form onsubmit="return validate()" method="POST">
            ...
            <input type="submit" class="btn btn-outline-success" value="Sign Up"><br><br>
            </form>
        </div>
        ...
        <div class="suggestion-container-login">
                    ...
                    <div class="suggestion-card">
                        ...
                        <div class="suggestion-content">
                        <h5>Not a Seller?</h5>
                        <p>Sign Up as Buyer in a few steps...<br><a class="menu__link" href="signup.php" target="_self" title="signup">Sign Up</a></p>
